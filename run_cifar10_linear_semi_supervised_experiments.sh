...
CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats

CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats_32
...
CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats_K1000
# Use K=400 training examples per category.
CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats_K400
# Use K=100 training examples per category.
CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats_K100
# Use K=20 training examples per category.
CUDA_VISIBLE_DEVICES=0 python main.py --exp=CIFAR10_LinearClassifier_on_RotNet_NIN4blocks_Conv2_feats_K20
